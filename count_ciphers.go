...
func main() {
	...
	for {
		...
		url := domain[0]
		cipher := fetch4(url)
		row := []string{url, cipher}
		data = append(data, row)
	}

	//write to output
	outputname := strings.Split(arg, ".")[0] + "_" + "count_cipher.csv"
...
func fetch4(url string) (cipher string) {
	fmt.Printf("domain: " + url + "\n")
	cipher = "nil"
	var cipherUint16 uint16
	...
	if (resp.TLS != nil) {
		cipherUint16 = resp.TLS.CipherSuite
